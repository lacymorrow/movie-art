# Contributing to movie-art

Thanks for considering a contribution! `movie-art` is small, stable, and gets the occasional bug-fix release.

## Setup

```bash
git clone https://github.com/lacymorrow/movie-art.git
cd movie-art
npm install
```
